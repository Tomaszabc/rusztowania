...
module Warehouse
  class StoragesController < ApplicationController
    ...
    def parts_on_site
      ...
      orders = Order.where(building_site: @site.name).where(status: %w[completed missing_parts])
    ...
    def order_params
      params.require(:order).permit(:new_delivery_date, :car_number, :storage_info, :hidden, :send_email,
