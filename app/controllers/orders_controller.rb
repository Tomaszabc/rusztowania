class OrdersController < ApplicationController
  ...
  def order_params
    params.require(:order).permit(:building_site, :delivery_date, :info, :building_site_info, :new_delivery_date, :car_number, :status, :storage_info, :checkbox, :send_email, order_lists_attributes: [:part_id, :quantity, :description, :delivery_quantity, :checkbox])
  end
